...
public class GoogleAdsInGame : MonoBehaviour
{
    ...
    #else
    private string _adUnitIdRE = "unused";
    #endif
    ...
    public void LoadRewardedAd()
    {
      ...
      RewardedAd.Load(_adUnitIdRe, adRequest,
    ...
    public void LoadInterstitialAd()
    {
      ...
      InterstitialAd.Load(_adUnitId, adRequest,
          ...
          RegisterReloadHandler1(interstitialAd);
    }

    private void RegisterEventHandlers1(InterstitialAd ad)
    {
        // Raised when the ad is estimated to have earned money.
        ad.OnAdPaid += (AdValue adValue) =>
        {
    ...
    private void RegisterReloadHandler1(InterstitialAd ad)
    {
        // Raised when the ad closed full screen content.
        ad.OnAdFullScreenContentClosed += ()=>
        {
